...
const BUILDS = [
  ...
  },
  {
    ...
    parts: [
      { k:'CPU',  v:'AMD 라이젠5 9600X (Granite Ridge)',       s:'325,910원' },
      { k:'쿨러', v:'DEEPCOOL AG400 G2 (싱글타워 공랭)',         s:'22,890원' },
      { k:'M/B',  v:'ASUS PRIME B650EM-A',                    s:'144,970원' },
      ...
      { k:'PSU',  v:'마이크로닉스 Classic II 600W 브론즈 ATX3.1', s:'61,320원' },
      { k:'케이스',v:'중급 어항 또는 팬 많은 케이스',    s:'80,000원' },
    ],
    tags: ['FHD 풀옵 게이밍','포토샵','주식','라이트룸','영화감상','여유로운 사무'],
    hl:  ['FHD 풀옵 게이밍','포토샵','주식'],
    note: '9600X: 구형 i9 대비 게이밍 프레임 우위',
    ctaBg: 'var(--accent)',
  },
  {
    ...
    parts: [
      ...
      { k:'쿨러', v:'발키리 GL360 ARGB',                s:'165,780원' },
      { k:'M/B',  v:'ASUS ROG STRIX B860-G GAMING WIFI',           s:'295,920원' },
      ...
      { k:'PSU',  v:'SuperFlower LEADEX VII 850W',                  s:'194,840원' },
